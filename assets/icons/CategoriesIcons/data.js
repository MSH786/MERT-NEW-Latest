...
export const categories = selectedCategoryIndex => [
  {
    ...
    icon: (
      <AllIcon
        fill={
          selectedCategoryIndex === 0 ? Colors.categoriesOrange : 'gray'
        }
        width={24}
        height={24}
      />
  ...
  },
  {
    icon: (
      <SmallCarIcon
        fill={
          selectedCategoryIndex === 1 ? Colors.categoriesOrange : 'gray'
        }
        width={40}
        height={40}
      />
  ...
  },
  {
    icon: (
      <CarCategoryIcon
        color={
          selectedCategoryIndex === 2 ? Colors.categoriesOrange : 'gray'
        }
        fill={
          selectedCategoryIndex === 2 ? Colors.categoriesOrange : 'gray'
        }
        stroke={
          selectedCategoryIndex === 2 ? ColorsS.categoriesOrange : 'gray'
        }
        width={40}
        height={40}
      />
  ...
  },
  {
    icon: (
      <BicycleIcon
        fill={
          selectedCategoryIndex === 3 ? Colors.categoriesOrange : 'white'
        }
        width={40}
        height={40}
      />
  ...
  },
  {
    icon: (
      <VanIcon
        fill={
          selectedCategoryIndex === 4 ? Colors.categoriesOrange : 'gray'
        }
        width={40}
        height={40}
      />
  ...
  },
  {
    icon: (
      <TruckIcon
        fill={
          selectedCategoryIndex === 5 ?Colors.categoriesOrange : 'white'
        }
        width={40}
        height={40}
      />
  ...
  },
  {
    icon: (
      <Truck2Icon
        fill={
          selectedCategoryIndex === 6 ? Colors.categoriesOrange : 'white'
        }
        width={40}
        height={40}
      />
